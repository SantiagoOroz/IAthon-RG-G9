...
def estado_inicial():
    ...
    return {
        ...
        # Tiempo acumulado (segundos) con cuerpo detectado. Los frames sin cuerpo no suman a ninguno.
        "postura_tiempo": {"ok": 0.0, "riesgo": 0.0},
        "actualizado": None,
    }
...
def escribir_estado(estado):
    ...
    En Windows, si el tablero (Streamlit) tiene abierto estado.json justo cuando
    intentamos reemplazarlo, os.replace lanza PermissionError [WinError 5]. El
    handle de lectura dura un instante, así que reintentamos con una pausa breve.
    """
