...
SEG_CONFIRMAR_POSTURA = 0.8   # segundos que debe sostenerse la mala postura antes de marcarla en rojo (anti-parpadeo)
...
PROMPT_AUDITOR = (
    ...
    '{"estado": "APROBADO" | "RECHAZADO", "objeto": "<nombre breve del objeto analizado, max 4 palabras>", "motivo": "<explicacion breve, max 12 palabras>"}\n'
